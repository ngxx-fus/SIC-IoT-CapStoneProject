...
class Ui_MYAPP(object):
    def setupUi(self, MYAPP):
        ...
        self.Widget.setGeometry(QRect(390, 90, 341, 281))
        ...
        self.RefreshButton.setGeometry(QRect(240, 250, 80, 22))
        ...
        self.ServerConnection_Title.setGeometry(QRect(10, 20, 131, 16))
        ...
        self.ServerConnection_Value.setGeometry(QRect(150, 20, 201, 16))
        ...
        self.SetResetFireAlert_Button.setGeometry(QRect(180, 60, 151, 22))
    ...
    def retranslateUi(self, MYAPP):
        ...
        self.ServerConnection_Title.setText(QCoreApplication.translate("MYAPP", u"Server connection:", None))
        ...
        self.FullScreenButton.setText(QCoreApplication.translate("MYAPP", u"FullScreen", None))
